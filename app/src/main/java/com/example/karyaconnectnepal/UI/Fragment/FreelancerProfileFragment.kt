...
class FreelancerProfileFragment : Fragment() {
    ...
    private var _binding: FragmentFreelancerProfileBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (currentUser != null) {
            ...
            userRef.get().addOnSuccessListener { snapshot ->
                ...
                binding.ViewFreelancerFullName.text = fullName
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == IMAGE_PICK_REQUEST && resultCode == Activity.RESULT_OK) {
            ...
            if (selectedImageUri != null) {
                binding.imageDisplay.setImageURI(selectedImageUri)  // Show selected image
